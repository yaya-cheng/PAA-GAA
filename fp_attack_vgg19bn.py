    ...
    for layer_name in vgg19_layer_list:
        ...
        for i, (x, y) in (enumerate(val_loader)):
            if i != args.num // args.batchsize:
                ...
                with torch.no_grad():
                    target_y = getTarClas(x, y, vgg_19, args.byRank)
                    furthest_feature = getFurthestFeature(x, vgg_19, target_y, library, args.method, args.kernel_for_furthe, args.GAA, args.c)
                x_adv = attack_fp(x, furthest_feature, vgg_19, args.kernel_type, args.GAA, args.c, args.method).detach_()
                # save adv img
        ...
        del list_vgg, list_y, num, utr, tsuc, ttr, x_adv
        for h in handlers:
            h.remove()
